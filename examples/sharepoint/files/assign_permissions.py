...
role_def = client.web.role_definitions.get_by_type(RoleType.Contributor)  # address role by type
user = client.web.site_users.get_by_email(test_user_principal_name_alt)  # address user by email
target_file = client.web.get_file_by_server_relative_path(file_url)  # address file by relative url
