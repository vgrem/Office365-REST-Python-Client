...
class ListItem(SecurableObject):
    ...
    def share_link(self, link_kind, expiration=None, role=None, password=None):
        ...
        :param datetime.datetime or None expiration: A date/time string for which the format conforms to the
            ...
            time and date of expiry for the tokenized sharing link. Both the minutes and hour value MUST be specified
            for the difference between the local and UTC time. Midnight is represented as 00:00:00. A null value
            indicates no expiry.
