...
class TermsOfUseContainer(Entity):
    ...
    def agreements(self):
        ...
        return self.properties.get('agreements',
                                   EntityCollection(self.context, Agreement,
                                                    ResourcePath("agreements", self.resource_path)))
    ...
    def agreement_acceptances(self):
        ...
        """
        return self.properties.get('agreementAcceptances',
                                   EntityCollection(self.context, AgreementAcceptance,
