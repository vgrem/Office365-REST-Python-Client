...
class ServicePrincipal(DirectoryObject):
    ...
    def add_key(self, key_credential, password_credential, proof):
        ...
        :param PasswordCredential password_credential: Only secretText is required to be set which should contain the
            password for the key. This property is required only for keys of type X509CertAndPassword. Set it to null
            otherwise.
