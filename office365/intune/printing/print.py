...
class Print(Entity):
    ...
    def connectors(self):
        ...
        return self.properties.get('connectors',
                                   EntityCollection(self.context, PrintConnector,
                                                    ResourcePath("connectors", self.resource_path)))

    @property
    def shares(self):
        """The list of printer shares registered in the tenant."""
        return self.properties.get('shares',
                                   EntityCollection(self.context, PrinterShare,
                                                    ResourcePath("shares", self.resource_path)))
